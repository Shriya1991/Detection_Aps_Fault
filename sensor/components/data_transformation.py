...
from sklearn.preprocessing import RoubustScaler 
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)-> Pipeline:
      try:
         simple_imputer = SimpleImputer(strategy = "constant", fill_value=0) # here we can define mean as well
         #we are using constant imputer which we will find in jupyter notebook 
    ...
    def initiate_data_transformation(self,)-> DataTransformationArtifact:
      try:
         ...
         #selecting input features for train & test dataframe
         ...
         #target encoder 
         train_arr = np.c(input_feature_train_df, target_feature_train_arr)
         ...
         utils.save_object(file_path=self.target_encoder_path, obj = label_encoder)
         ...
         data_transformation_artifact = artifact_entity.DataTransformationArtifact(
            ...
            target_encoder_path =self.data_transformation_config.target_encoder_pat)
